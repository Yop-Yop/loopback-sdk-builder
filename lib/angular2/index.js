...
module.exports = function generate(ctx) {
  ...
  function buildServiceDI(isIo) {
    ...
    if (isIo === 'enabled') {
      dependencies.push('@Inject(SocketConnection) protected overrides connection: SocketConnection');
    }
    dependencies = dependencies.concat([
      '@Inject(SDKModels) protected overrides models: SDKModels',
      '@Inject(LoopBackAuth) protected overrides auth: LoopBackAuth',
      '@Optional() @Inject(ErrorHandler) protected overrides errorHandler: ErrorHandler'
    ])
