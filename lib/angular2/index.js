...
module.exports = function generate(ctx) {
  ...
  function buildServiceDI(isIo) {
    let dependencies = ['@Inject(HttpClient) protected override http: HttpClient'];
    if (isIo === 'enabled') {
      dependencies.push('@Inject(SocketConnection) protected override connection: SocketConnection');
    }
